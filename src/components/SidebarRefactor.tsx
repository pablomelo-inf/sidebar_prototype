  ...
  return (
    <aside className='h-screen'>
      <nav className='h-full flex flex-col bg-white border-r shadow-sm'>
        ...
        <LogoSection isSidebarExpanded={isSidebarExpanded} onToggle={toggleSidebar} />
        ...
        <div className='border-t flex p-3'>
          ...
          <div
            className={`
                ...
                overflow-hidden transition-all ${isSidebarExpanded ? 'w-52 ml-3' : 'w-0'}
            `}
          >
...
function LogoSection({isSidebarExpanded, onToggle}: {isSidebarExpanded: boolean, onToggle: () => void}){
  return (<div className='p-4 pb-2 flex justify-between items-center'>
          <img
...
export function SidebarItem({ icon, text, isActive, hasAlert }: SidebarMenuItemProps) {
  ...
  return (
    ...
    >
      ...
      {hasAlert && (
        <AlertIndicator isSidebarExpanded={isSidebarExpanded} />
      )}
